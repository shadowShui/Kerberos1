...
//		System.out.println(de);
	...
	public long[] byteToLong(final byte[] data) {
		...
		for (int i = 0; i < length_long; i ++) {
			res[i] = ((long)data[ i*8 ] << 56 & 0xFF00000000000000L)
				   + ((long)data[ i*8 + 1 ] << 48 & 0xFF000000000000L)
				   + ((long)data[ i*8 + 2 ] << 40 & 0xFF0000000000L)
				   + ((long)data[ i*8 + 3 ] << 32 & 0xFF00000000L)
				   + ((long)data[ i*8 + 4 ] << 24 & 0xFF000000L)
				   + ((long)data[ i*8 + 5 ] << 16 & 0xFF0000L)
				   + ((long)data[ i*8 + 6 ] << 8 & 0xFF00L)
				   + ((long)data[ i*8 + 7 ] & 0xFFL);
		}
		return res;
	}
