...
public class ASServerThread_copy extends Thread {
	
	private static final int LifeTime = 8;//设置生命周期为8s

	private static final long Ektgs = 123;		// AS和TGS公有秘钥
	private final long Ekctgs = 123;	// TGS至C会话秘钥
    ...
    public ASServerThread_copy(Socket socket) {
