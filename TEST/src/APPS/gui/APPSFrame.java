 ...
 * @author fangyunniu
 */
public class APPSFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(APPSFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
